  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 my-24'>
      <div className='text-center'>
        ...
        <p className='text-gray-500 max-w-lg mx-auto'>Unlock a powerful suite of AI tools built to transform your ideas into high-quality content. Write, create, enhance, and optimize—all in one seamless platform.</p>
      </div>
